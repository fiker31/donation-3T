...
namespace DAL
{
    public class Ticket_CategoryData : BaseData<Ticket_Category>
    {
        ...
        public long Insert(DBDataContext db, string CategoryName, string insertUserID)
        {
            //Create a new object 
            Ticket_Category TD = new Ticket_Category
            {
        ...
        public bool Update(DBDataContext db, long ID, string CategoryName, string insertUserID, string updateUserID, DateTime entryDate, Binary version)
        {
            //Create a new object 
            Ticket_Category TD = new Ticket_Category
            {
