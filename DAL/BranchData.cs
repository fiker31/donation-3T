...
namespace DAL
{
    public class BranchData : BaseData<Branch>
    {
        ...
        public long Insert(DBDataContext db, string Name, long districtID, string T24Code, string Address, string Contact, string insertUserId)
        {
            //Create a new object 
            Branch TD = new Branch
            {
        ...
        public bool Update(DBDataContext db, long Id, string Name, long districtID, string T24Code, string Address, string Contact, string insertUserId, string updateUserId, DateTime entryDate, Binary version)
        {
            //Create a new object 
            Branch TD = new Branch
            {
