...
using BLL.Framework;
public partial class ManageAccount_ManegeAccount : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            EntMenuItemBO administrationMenuItem = Globals.GetMenuItems(Cache).GetByMenuItemName("Manage Account");
