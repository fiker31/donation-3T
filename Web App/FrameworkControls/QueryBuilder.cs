...
using MISBLL.Framework ;
using MISBLL.Reports;
...
{    
    ...
    {                    
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                //QueryObjectName = "MISBLL.Reports.DepositByRangeQueryBO, MISBLL, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
