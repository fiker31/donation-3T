...
using System.Text;
using PMSDAL;
using PMSDAL.Reports;
using PMSBLL.Framework;


namespace PMSBLL.Reports
{
    ...
    public class PMSReportsBO : BaseBO
    {
        ...
        protected override void MapEntityToCustomProperties(PMSDAL.Framework.IBaseEntity entity)
        {
    ...
    {
        public static object[] IndividualReport(DateTime DateFrom, DateTime DateTo, long performer, long projectId)
        {
            return ReportData.IndividualReport(DateFrom, DateTo, performer, projectId).ToArray();
        }
        public static object[] ProjectTeamReport(DateTime DateFrom, DateTime DateTo,  long projectId)
        {
            return ReportData.ProjectTeamReport(DateFrom, DateTo,  projectId).ToArray();
        }
        public static object[] ProjectStatus(long projectId)
        {
            return ReportData.ProjectStatus(projectId).ToArray();
        }

        public static object[] project(long projectId)
        {
            return ReportData.project(projectId).ToArray();
        }
        public static object[] members(long projectId)
        {
            return ReportData.TeamMembers(projectId).ToArray();
        }
    }
