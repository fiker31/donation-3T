...
namespace BLL.Framework
{
    ...
    public abstract class BaseEO : BaseBO
    {
        ...
        /// </summary>
        public abstract bool Save(AppDataContext db, ref EntValidationErrors validationErrors, string userAccountId);
        /// <summary>
        ...
        /// </summary>
        protected abstract void Validate(AppDataContext db, ref EntValidationErrors validationErrors);
        /// <summary>
        ...
        /// </summary>
        protected abstract void DeleteForReal(AppDataContext db);
        /// <summary>
        /// This method validates the object's data before trying to delete the record.  If there is a validation error
        /// the validationErrors will be populated with the error message.
        /// </summary>
        protected abstract void ValidateDelete(AppDataContext db, ref EntValidationErrors validationErrors);
        /// <summary>
        ...
        public bool Save(ref EntValidationErrors validationErrors, string userAccountId)
        {
            if (DBAction == DBActionEnum.Insert || DBAction == DBActionEnum.Update)
            {
                ...
                {
                    // Create connection 
                    using (AppDataContext db = new AppDataContext(GetConnectionString()))
                    {
                        //Now save the record
        ...
        /// Deletes the record.
        /// </summary>
        internal virtual bool Delete(AppDataContext db, ref EntValidationErrors validationErrors, string userAccountId)
        {
            if (DBAction == DBActionEnum.Delete)
            {
