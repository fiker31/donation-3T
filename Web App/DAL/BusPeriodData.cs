...
namespace DAL
{
    public class BusPeriodData : BaseData<BusPeriod>
    {
        ...
        public long Insert(AppDataContext db, string businessPeriod, byte pStatus, string insertUserId)
        {
            //Create a new object 
            BusPeriod TD = new BusPeriod
            {
        ...
        public bool Update(AppDataContext db, long rowId, string businessPeriod, byte pStatus, string insertUserId, string updateUserId, DateTime entryDate, Binary version)
        {
            //Create a new object 
            BusPeriod TD = new BusPeriod
            {
