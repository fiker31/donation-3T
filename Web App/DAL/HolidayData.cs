...
namespace DAL
{
    public class HolidayData : BaseData<Holiday>
    {
        ...
        public long Insert(AppDataContext db, string holidayName, DateTime holidayDate, string insertUserId)
        {
            //Create a new object 
            Holiday TD = new Holiday
            {
        ...
        public bool Update(AppDataContext db, long id, string holidayName, DateTime holidayDate, string insertUserId, string updateUserId, DateTime entryDate, Binary version)
        {
            //Create a new object 
            Holiday TD = new Holiday
            {
        ...
        public bool IsDuplicateEntry(AppDataContext db, DateTime holidayDate)
        {
